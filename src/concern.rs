...
pub enum Acknowledgment {
    ...
    Majority,
    /// Requires acknowledgment according to the given write tag. See [here](https://docs.mongodb.com/manual/tutorial/configure-replica-set-tag-sets/#tag-sets-and-custom-write-concern-behavior)
