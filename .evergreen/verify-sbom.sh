...
#                       Default: Cargo.toml Cargo.lock **/Cargo.toml
#  SBOM_FILE            Path to canonical SBOM file (default sbom.json)
...
MANIFEST_PATTERNS="${MANIFEST_PATTERNS:-*.toml *.lock **/*.toml **/*.lock}"
